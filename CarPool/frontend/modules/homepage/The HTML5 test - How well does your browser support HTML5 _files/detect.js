...
var UserAgents = (function(){
	...
	Detected.prototype = {
		initialize: function(options) {
			...
			this.browser = { stock: false, hidden: false, channel: "", mode: "", name: "Chrome", version: new Version({ value: "24.0.1312.56", details: 1 }) };
			this.engine = { name: "Webkit", version: new Version({ value: "537.17" }) };
			this.os = { name: "Windows", version: new Version({ value: "6.1", alias: "7" }) };
